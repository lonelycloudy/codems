...
REPOS_ROOT = '/var/svn_base/'
REPOS_URL = 'http://taocode.etentec.com:8080/svn/'
REPOS_ADMIN_URL = 'http://taocode.etentec.com:8080/adminsvn/'
HOOK_LOGS = '/var/django/taocode2/err_hooks.log'
...
DATABASES = {
    'default': {
        ...
        'USER': 'mobilehub',                      # Not used with sqlite3.
        'PASSWORD': 'mobilehub',                  # Not used with sqlite3.
